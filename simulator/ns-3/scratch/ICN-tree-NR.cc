...
void ReqsPreProcess(int ObjectCount,int NodeCount,int levels, int time_factor, int xy_min, int xy_max, int k, string traceName){
...
void simulate(string line, string traceName){
...
main (int argc, char *argv[])
{
	//int runNo=1;
	//int clsNo=9;
	string input="0.0,256,1,0,0,0";
	//string input="0.0,2048,0.0000,0.3270,0.6730,0.0000";
    CommandLine cmd;
