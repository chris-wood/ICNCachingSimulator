...
struct IntervalRoutingTable
{
  ...
  IntervalRoutingTable () : // default values
                         nodeId(), nodeAddr(), destAddr (), nextAddr (),
                         interface (0), distance (0) {};
};
...
private:
 ...
 // OlsrState m_state;
  ...
  Ptr<Ipv4> m_ipv4;
  static IntervalRoutingTable intervalRT[1000];
  void Clear ();
  ...
  void IntervalRoutingTableComputation ();
