...
public:
	...
	static void faceChange();
	static int	getNodeId(Ipv4Address add, uint32_t &ifindex);
	static void RunAlgorithm();
	static bool	findBestIntervalMatch(int src, int des, int &match, int minIntSize, int minIntervals[][5], int dirSerSize, int dirServices[][3]);
	static bool findDesInFace(int match, int &inFace, int minIntervals[][5]);
	static bool FindLabelforRoot(int root, int node, int &label, int dirSerSize, int dirServices[][3]);
  OlsrState ()
  {}
...
extern double netArea;
extern bool olsr_interval;
extern iVector routes_currNode, routes_destNode, routes_nextHop, routes_ne_inface, routes_des_inface;
...
public:
	...
	static int	getNodeId(Ipv4Address add, uint32_t &ifindex);
	static void RunAlgorithm();
	static bool	findBestIntervalMatch(int src, int des, int &ne_node);
	//static bool findDesInFace(int match, int &inFace, int minIntervals[][5]);
	//static bool FindLabelforRoot(int root, int node, int &label, int dirSerSize, int dirServices[][3]);
  OlsrState ()
  {}
