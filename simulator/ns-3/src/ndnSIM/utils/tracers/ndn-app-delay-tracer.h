...
static double GetAvrageHopCount();
static double GetAvrageAggHop();
static int GetIncreaseHopCount(int hopCnt, bool isTotal);
static int GetIncreaseAggCount(bool isEdge);
static int GetIncreaseAggCountPerObj(int Obj, int NodeID);
static int GetIncreasePrefixRequest(int NodeID, std::string str);
static int GetIncreaseObjRequest(int Obj,int NodeId);
static int GetIncreaseObjRequest(int Obj);
